...
sustantivo("manzanas", femenino, plural, contable).
...
sustantivo("átomo", masculino, singular, técnico).
sustantivo("molécula", femenino, singular, técnico).
sustantivo("célula", femenino, singular, técnico).
sustantivo("software", masculino, singular, técnico).
sustantivo("algoritmo", masculino, singular, técnico).
sustantivo("base_de_datos", femenino, singular, técnico).
sustantivo("inteligencia_artificial", femenino, singular, técnico).
...
sustantivo("montaña", femenino, singular, lugar).
