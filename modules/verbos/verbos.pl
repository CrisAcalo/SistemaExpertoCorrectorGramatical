...
% Verbos modales
verbo(modal, infinitivo, 'poder').
verbo(modal, infinitivo, 'deber').
verbo(modal, infinitivo, 'querer').
...
% Verbos auxiliares
verbo(auxiliar, infinitivo, 'haber').
verbo(auxiliar, infinitivo, 'ser').
verbo(auxiliar, infinitivo, 'estar').
